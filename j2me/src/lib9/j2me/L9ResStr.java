...
public class L9ResStr {
	private String _sToken = "XXXX";
	private String _sSep = ",";

	public void setTokenAndSep(String sToken, String sSep) {
		_sToken = sToken;
		_sSep = sSep;
	}
	 ...
	 * 注意替换字符串sReplace以sep分隔，使用如下： String str=“红队的成绩，分数XXXX,所用时间XXXX分钟!”;
	...
	public String getResStr(int res_id, String sReplace) {
		return getResStr(res_id, _sToken, sReplace, _sSep);
	}
}
